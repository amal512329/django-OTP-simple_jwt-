...
SECRET_KEY = 'django-insecure-r(x*3!c*i(gi^n8iysi5!q3#z4aauy%**z)fjd2wg6agtg7_cv'
...
INSTALLED_APPS = [
    'corsheaders',  # CORS : FOR ACCESS API REQUEST FROM WHITELISTED HOSTS
...
DJ_REST_AUTH_SERIALIZERS = {
    'LOGIN_SERIALIZER': 'user.serializers.OTPLoginSerializer',
    'LOGIN_VIEW': 'user.views.OTPLoginView',
}
